...
export function H1({ className, ...props }: TextProps) {
  return (
    <h1
      className={cn(
        "bg-gradient-to-b from-zinc-900 to-zinc-600 bg-clip-text text-5xl font-extrabold tracking-wider text-transparent dark:from-zinc-100 dark:to-zinc-400",
        className,
      )}
      {...props}
    />
...
export function H2({ className, ...props }: TextProps) {
  return (
    <h2
      className={cn(
        "bg-gradient-to-b from-zinc-900 to-zinc-600 bg-clip-text text-4xl font-bold tracking-wide text-transparent dark:from-zinc-100 dark:to-zinc-400",
        className,
      )}
      {...props}
    />
